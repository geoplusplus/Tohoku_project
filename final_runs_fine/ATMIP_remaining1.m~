function output = ATMIP_remaining1(opt,beta,post,samplestage,stage,num) 
...
if stage == 0 
    ...
    for i = 1:N
        ...
        b = toc; 
        if b>100 && b<110
            fprintf('creating cov for MH, taking time at i = %d\n',i)
        end
    end
    ...
    save([dirname '/' subdir '/sol_1st.mat'],'opt','beta','post','samplestage','stage','covsmpl','num');
